...
TEST_F(NinjaRustBinaryTargetWriterTest, RlibInLibrary) {
  ...
  const char expected[] =
      ...
      "-Lnative=obj/pub_sset_in_staticlib -Lnative=obj/priv_sset_in_staticlib -Lnative=obj/staticlib "
      "-Clink-arg=-Bdynamic "
...
TEST_F(NinjaRustBinaryTargetWriterTest, RlibWithLibDeps) {
...

  {
    ...
    const char expected[] =
        ...
        "  rustdeps = -Ldependency=obj/bar -Lnative=obj/clib -Clink-arg=-Bdynamic "
...
TEST_F(NinjaRustBinaryTargetWriterTest, TransitiveRustDepsThroughSourceSet) {
...

  {
    ...
    const char expected[] =
        ...
        "  rustdeps = -Ldependency=obj/public -Ldependency=obj/private -Lnative=obj/sset "
        "-Clink-arg=-Bdynamic "
