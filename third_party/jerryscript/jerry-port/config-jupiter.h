...
#define CONTEXT_SIZE_FOR_TASK (5)
...
// >= 51400 + (64-48) * 1024 + 8
#define JS_TASK_CONTEXT_AND_HEAP_SIZE_BYTE (JS_TASK_HEAP_SIZE * CONVERTION_RATIO + 5000 + 16)

#ifndef JERRY_ENABLE_SNAPSHOT_VERSION_CHECK
#define JERRY_ENABLE_SNAPSHOT_VERSION_CHECK (1)
#endif /* JERRY_ENABLE_SNAPSHOT_VERSION_CHECK */
