...
/*
 * @tc.name      : significandf_0400
 * @tc.desc      : Get mantissa of negative floating-point number
 * @tc.level     : Level 1
 */
void significandf_0400(void)
{
    float f = significandf(-12.25f);
    EXPECT_FLOAT_EQ(-1.53125f, f);
}
...
/*
 * @tc.name      : significandf_0500
 * @tc.desc      : Get mantissa of floating-point number 1.0f
 * @tc.level     : Level 1
 */
void significandf_0500(void)
{
    float f = significandf(1.0f);
    EXPECT_FLOAT_EQ(1.0f, f);
}

/*
 * @tc.name      : significandf_0600
 * @tc.desc      : Get mantissa of NaN
 * @tc.level     : Level 1
 */
void significandf_0600(void)
{
    float f = significandf(NAN);
    if (!isnan(f)) {
        t_error("%s failed: %f is not NaN\n", __func__, f);
    }
}
