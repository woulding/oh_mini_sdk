...
/*
 * @tc.name      : significand_0500
 * @tc.desc      : Get mantissa of floating-point number 1.0
 * @tc.level     : Level 1
 */
void significand_0500(void)
{
    double d = significand(1.0);
    EXPECT_DOUBLE_EQ(1.0, d);
}

/*
 * @tc.name      : significand_0600
 * @tc.desc      : Get mantissa of NaN
 * @tc.level     : Level 1
 */
void significand_0600(void)
{
    double d = significand(NAN);
    if (!isnan(d)) {
