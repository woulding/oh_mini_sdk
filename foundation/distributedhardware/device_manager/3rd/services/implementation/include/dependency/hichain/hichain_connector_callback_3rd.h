...
#ifndef OHOS_DM_HICHAIN_CONNECTOR_CALLBACK_3RD_H
#define OHOS_DM_HICHAIN_CONNECTOR_CALLBACK_3RD_H

namespace OHOS {
namespace DistributedHardware {
class IDmDeviceAuthCallback3rd {
public:
...
#endif // OHOS_DM_HICHAIN_CONNECTOR_CALLBACK_3RD_H
