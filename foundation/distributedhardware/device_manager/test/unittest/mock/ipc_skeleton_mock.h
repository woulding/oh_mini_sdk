...
#ifndef OHOS_DM_IPC_SKELETON_MOCK_H
#define OHOS_DM_IPC_SKELETON_MOCK_H
...
public:
    ...
    static std::shared_ptr<IPCSkeletonInterface> GetOrCreateIPCSkeleton();
    static void ReleaseIPCSkeleton();
private:
    static std::shared_ptr<IPCSkeletonInterface> skeleton_;
};
...
#endif // OHOS_DM_IPC_SKELETON_MOCK_H
