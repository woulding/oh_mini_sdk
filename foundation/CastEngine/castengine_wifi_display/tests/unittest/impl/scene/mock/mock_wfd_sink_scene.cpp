...
void MockWfdSinkScene::MockInitialize()
{
...
std::shared_ptr<Wifi::WifiP2p> MockWfdSinkScene::MockGetP2pInstance()
{
    return p2pInstance_;
}

std::shared_ptr<IpcMsgAdapter> MockWfdSinkScene::MockGetIpcAdapter()
{
    return ipcAdapter_.lock();
}

std::shared_ptr<ISharingAdapter> MockWfdSinkScene::MockGetSharingAdapter()
{
