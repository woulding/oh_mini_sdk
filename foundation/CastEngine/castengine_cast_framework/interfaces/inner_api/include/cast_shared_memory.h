...
#ifndef CAST_SHARED_MEMORY_H
#define CAST_SHARED_MEMORY_H
 ...
 */
class __attribute__((visibility("default"))) CastSharedMemory {
public:
    virtual ~CastSharedMemory() = default;
