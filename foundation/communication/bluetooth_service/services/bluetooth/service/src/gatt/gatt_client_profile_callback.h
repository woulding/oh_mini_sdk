...
public:
    ...
    virtual void OnReadCharacteristicValueEvent(
    ...
    virtual void OnWriteLongCharacteristicValueEvent(
        int reqId, uint16_t connectHandle, uint16_t handle, int result) {};
