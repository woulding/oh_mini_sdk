...
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P50_100_200_WINDOW_MS = 100;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P50_100_200_INTERVAL_MS = 200;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P10_30_300_WINDOW_MS = 30;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P10_30_300_INTERVAL_MS = 300;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P2_30_1500_WINDOW_MS = 30;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P2_30_1500_INTERVAL_MS = 1500;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P75_30_40_WINDOW_MS = 30;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P75_30_40_INTERVAL_MS = 40;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P50_30_60_WINDOW_MS = 30;
constexpr uint16_t BLE_SCAN_MODE_BATCH_OP_P50_30_60_INTERVAL_MS = 60;
...
typedef enum {
    ADV_STATUS_DEFAULT = 0x00,
    ADV_STATUS_READ_TX_POWER,
    ADV_STATUS_SET_PARA,
    ADV_STATUS_SET_ADV_DATA,
    ADV_STATUS_SET_SCAN_DATA,
    ADV_STATUS_SET_RAN_ADDR,
    ADV_STATUS_STARTING,
    ADV_STATUS_STARTED,
    ADV_STATUS_STOPING,
    ADV_STATUS_STOPED
