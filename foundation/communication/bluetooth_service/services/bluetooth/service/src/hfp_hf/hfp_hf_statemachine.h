...
public:
    HfpHfState(const std::string &name, utility::StateMachine &statemachine, HfpHfProfile &profile, int stateInt,
        ...
        : State(name, statemachine, parent), profile_(profile),
        stateInt_(stateInt), stateMachine_((HfpHfStateMachine &)statemachine) {}

    HfpHfState(const std::string &name, utility::StateMachine &statemachine, HfpHfProfile &profile, int stateInt)
        : State(name, statemachine), profile_(profile),
        stateInt_(stateInt), stateMachine_((HfpHfStateMachine &)statemachine) {}
