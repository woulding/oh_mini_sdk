...
#ifndef TEST_MOCK_COMMON_DEMO_SA_INCLUDE_DEAM_SERVICE_H
#define TEST_MOCK_COMMON_DEMO_SA_INCLUDE_DEAM_SERVICE_H
...
#endif // TEST_MOCK_COMMON_DEMO_SA_INCLUDE_DEAM_SERVICE_H
