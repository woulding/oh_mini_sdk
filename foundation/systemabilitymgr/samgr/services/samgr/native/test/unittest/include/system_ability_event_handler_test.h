...
#ifndef SYSTEM_ABILITY_EVENT_HANDLER_TEST_H
#define SYSTEM_ABILITY_EVENT_HANDLER_TEST_H

#include "gtest/gtest.h"
#include "schedule/system_ability_state_listener.h"

namespace OHOS {
class SystemAbilityEventHandlerTest : public testing::Test {
public:
...
class StateListener : public SystemAbilityStateListener {
public:
...
#endif /* SYSTEM_ABILITY_EVENT_HANDLER_TEST_H */