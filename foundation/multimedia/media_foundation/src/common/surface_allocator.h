...
#ifndef HISTREAMER_PLUGINS_COMMON_SURFACE_ALLOCATOR_H
#define HISTREAMER_PLUGINS_COMMON_SURFACE_ALLOCATOR_H
...
#endif
#endif // HISTREAMER_PLUGINS_COMMON_SURFACE_BUFFER_H
