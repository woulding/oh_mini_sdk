...
public:
    ...
    LocaleInfo(const std::string &localeTag, const std::map<std::string, std::string> &configs);
    virtual ~LocaleInfo();
...
private:
    ...
    void InitLocaleInfo(const std::string &localeTag, const std::map<std::string, std::string> &configMap);
};
} // namespace I18n
} // namespace Global
} // namespace OHOS
