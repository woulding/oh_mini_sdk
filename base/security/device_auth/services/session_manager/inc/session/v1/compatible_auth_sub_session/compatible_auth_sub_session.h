...
#ifndef COMPATIBLE_AUTH_SUB_SESSION_H
#define COMPATIBLE_AUTH_SUB_SESSION_H
...
int32_t CreateClientAuthSubSession(CJson *in, const DeviceAuthCallback *callback, CompatibleBaseSubSession **session);
int32_t CreateServerAuthSubSession(CJson *in, const DeviceAuthCallback *callback, CompatibleBaseSubSession **session);
