...
#ifndef COMPATIBLE_BIND_SUB_SESSION_H
#define COMPATIBLE_BIND_SUB_SESSION_H
...
int32_t CreateClientBindSubSession(CJson *in, const DeviceAuthCallback *callback, CompatibleBaseSubSession **session);
int32_t CreateServerBindSubSession(CJson *in, const DeviceAuthCallback *callback, CompatibleBaseSubSession **session);
