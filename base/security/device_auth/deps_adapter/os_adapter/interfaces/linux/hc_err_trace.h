...
#define SET_LOG_MODE_AND_ERR_TRACE(mode, isErrTraceOn) SetLogModeAndErrTrace(mode, isErrTraceOn)
#define SET_TRACE_ID(traceId) SetTraceId(traceId)

#define RECORD_ERR_TRACE(funName, lineNum, fmt, ...) RecordErrTrace(funName, lineNum, fmt, ##__VA_ARGS__)

#define GET_ERR_TRACE_LEN() GetErrTraceLen()
#define GET_ERR_TRACE() GetErrTrace()
