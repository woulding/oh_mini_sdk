 ...
 */
#ifndef INTERFACES_INNER_API_UNIFIED_COLLECTION_UTILITY_GPU_COLLECTOR_H
#define INTERFACES_INNER_API_UNIFIED_COLLECTION_UTILITY_GPU_COLLECTOR_H
#include <memory>
...
#endif // INTERFACES_INNER_API_UNIFIED_COLLECTION_UTILITY_GPU_COLLECTOR_H