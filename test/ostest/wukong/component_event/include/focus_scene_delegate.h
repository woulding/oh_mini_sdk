...
#ifndef TEST_WUKONG_FOCUS_SCENE_DELEGATE_H
#define TEST_WUKONG_FOCUS_SCENE_DELEGATE_H
...
namespace OHOS {
namespace WuKong {
class FocusSceneDelegate : public DelayedSingleton<FocusSceneDelegate> {
public:
    FocusSceneDelegate();
    ~FocusSceneDelegate();
    ...
    /**
     * @brief judge whether page changed
...
#endif  // TEST_WUKONG_FOCUS_SCENE_DELEGATE_H
