...
#ifndef TEST_WUKONG_WATCH_KEYPRESS_INPUT_H
#define TEST_WUKONG_WATCH_KEYPRESS_INPUT_H
...
namespace OHOS {
namespace WuKong {
class WatchKeyPressInput : public InputAction {
public:
    WatchKeyPressInput();
    ~WatchKeyPressInput();
...
#endif  // TEST_WUKONG_WATCH_KEYPRESS_INPUT_H
