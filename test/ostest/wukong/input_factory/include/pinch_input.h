...
#ifndef TEST_WUKONG_PINCH_INPUT_H
#define TEST_WUKONG_PINCH_INPUT_H
...
namespace OHOS {
namespace WuKong {
class PinchInput : public InputAction {
public:
    PinchInput();
    ~PinchInput();
    ...
    /**
     * @brief input a pinch event in random test.
...
#endif  // TEST_WUKONG_PINCH_INPUT_H
