...
#ifndef TEST_WUKONG_WATCH_CROWN_INPUT_H
#define TEST_WUKONG_WATCH_CROWN_INPUT_H
...
namespace OHOS {
namespace WuKong {
class WatchCrownInput : public InputAction {
public:
    WatchCrownInput();
    ~WatchCrownInput();
...
#endif  // TEST_WUKONG_WATCH_CROWN_INPUT_H
