...
#if defined(CONFIG_UART_SUPPORT_DMA_LLI) && defined(CONFIG_UART_SUPPORT_RECV_RAW_DATA)
/**
 * @if Eng
...
#endif  /* CONFIG_UART_SUPPORT_DMA_LLI && CONFIG_UART_SUPPORT_RECV_RAW_DATA */
 ...
 * @param  [in]  timeout 超时时间，该参数暂时未使用，当rx fifo为空时，内部循环至1000000次后，安全退出。
 * @return 实际读到的数据长度。
 * @endif
 */
