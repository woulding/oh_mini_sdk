 ...
 * @param  [in]     alg Crypto alg, see @ref uapi_drv_cipher_symc_alg_t.
 * @param  [in]     work_mode Crypto work mode， see @ref uapi_drv_cipher_symc_work_mode_t.
 * @param  [in]     bit_width Crypto key bit width， see @ref uapi_drv_cipher_symc_bit_width_t.
 ...
 * @note   There are two ways to set the key:
            1）Use the key/key_len combination. In this case, keyslot_handle is set to 0..
 ...
 * @else
 * @brief  加解密。
 * @param  [in]     alg 加解密算法， 参考 @ref uapi_drv_cipher_symc_alg_t 。
 * @param  [in]     work_mode 工作模式， 参考 @ref uapi_drv_cipher_symc_work_mode_t 。
 * @param  [in]     bit_width 密钥位宽， 参考 @ref uapi_drv_cipher_symc_bit_width_t 。
 * @param  [in]     src 源数据。
 * @param  [out]    dst 目的数据。
