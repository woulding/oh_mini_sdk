...
at_ret_t at_los_wifi_cali_online(const calionline_args_t *args)
{
    td_s32 argc = convert_bin_to_dec(args->para_map);
    td_u32 ret;
    ...
    ret = uapi_wifi_at_start(argc, (td_char *)&args->para1, EXT_AT_CALI_ONLINE);
    return ret;
}
...
{
#if defined(CONFIG_AT_DEBUG_REGISTER_CCPRIV) && (CONFIG_AT_DEBUG_REGISTER_CCPRIV == 1)
