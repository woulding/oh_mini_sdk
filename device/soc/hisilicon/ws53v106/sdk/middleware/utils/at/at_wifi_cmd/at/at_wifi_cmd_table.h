...
typedef struct {
    uint32_t                para_map;
    int32_t                 psm_debug_cmd;
    int32_t                 psm_debug_switch;
} ps_debug_args_t;
...
typedef struct {
    uint32_t                para_map;
    int32_t                 rate_mode; /* Range: 0..1 */
    int32_t                 cfg_frame_type; /* Range: 0..2 */
    int32_t                 rate_val; /* Range: 0..255 */
} fixrate_args_t;
...
typedef struct {
    uint32_t                para_map;
    int32_t                 cfg_frame_type; /* Range: 0..3 */
    int32_t                 tx_count0; /* Range: 0..7 */
    int32_t                 tx_count1; /* Range: 0..7 */
    int32_t                 tx_count2; /* Range: 0..7 */
    int32_t                 tx_count3; /* Range: 0..7 */
} tx_count_args_t;
...
typedef struct {
    uint32_t                para_map;
    int32_t                 net_type;
    const uint8_t           *dscp2tid_map; /* Length: 64 */
} dscp2tid_map_arg_t;
...
/* AT+TXCOUNT */
at_ret_t cmd_set_tx_count(const tx_count_args_t *args);

/* AT+FIXRATE */
at_ret_t cmd_autorate_fix_rate(const fixrate_args_t *args);

/* AT+PS */
at_ret_t cmd_set_sta_pm(const ps_args_t *args);

/* AT+PSDEBUG */
at_ret_t cmd_set_sta_psm_debug(const ps_debug_args_t *args);

/* AT+WIFIGETTSF */
at_ret_t cmd_get_wifi_tsf(const wifi_tsf_args_t *args);
...
/* AT+SETDSCPTIDMAP */
at_ret_t cmd_set_dscp_tid_map(const dscp2tid_map_arg_t *args);

static const at_para_parse_syntax_t cc_syntax[] = {
    {
...
static const at_para_parse_syntax_t sae_pwe_syntax[] = {
    {
...
static const at_para_parse_syntax_t sae_trans_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t sae_clog_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t sae_grp_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
...
static const at_para_parse_syntax_t sta_auth_type_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const at_para_parse_syntax_t start_promise_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const at_para_parse_syntax_t start_sdp_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const at_para_parse_syntax_t sdp_subscribe_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const int32_t conn_para3_values[] = {
    0, 1, 2, 3, 4, 7, 8, 10
};
static const at_para_parse_syntax_t conn_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .attribute = AT_SYNTAX_ATTR_OPTIONAL | AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
...
static const at_para_parse_syntax_t scanchn_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t scanssid_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_OPTIONAL | AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
...
static const at_para_parse_syntax_t scanbssid_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
...
static const int32_t reconn_enable_values[] = {
    0, 1
};
static const at_para_parse_syntax_t reconn_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
...
static const at_para_parse_syntax_t setapadv_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
...
static const int32_t startap_para3_values[] = {
    0, 1, 2, 3, 7, 8, 10, 14
};
static const at_para_parse_syntax_t startap_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
...
static const int32_t startsta_para1_values[] = {
    0, 1, 2, 3, 4
};
static const int32_t startsta_para2_values[] = {
    0, 1, 2
};
static const at_para_parse_syntax_t startsta_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
...
static const int32_t userieset_index_values[] = {
    1, 2, 3, 4
};
static const int32_t userieset_frame_type_bitmap_values[] = {
    1, 2, 4
};
static const int32_t userieset_ie_type_values[] = {
    221
};
static const int32_t userieset_ie_len_values[] = {
    4
};

static const at_para_parse_syntax_t userieset_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
        .entry.string.max_length = 32,
...
static const at_para_parse_syntax_t deauthsta_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH,
...
static const at_para_parse_syntax_t fconn_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .attribute = AT_SYNTAX_ATTR_OPTIONAL | AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
        .entry.string.max_length = 131,
...
static const int32_t csisetconfig_user_id_values[] = {
    0, 1, 2, 3
};
static const int32_t csisetconfig_enable_values[] = {
    0, 1
};
static const int32_t csisetconfig_cfg_match_ta_ra_sel_values[] = {
    0, 1
};
static const int32_t csisetconfig_sub_type_filter_enable_values[] = {
    0, 1
};
static const at_para_parse_syntax_t csisetconfig_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
        .entry.string.max_length = 32,
...
static const at_para_parse_syntax_t pin_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH,
...
static const int32_t sendpkt_para1_values[] = {
    0, 1
};

static const at_para_parse_syntax_t sendpkt_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_LIST_VALUE,
...
static const at_para_parse_syntax_t setrate_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t fixrate_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 1,
        .offset = offsetof(fixrate_args_t, rate_mode)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 2,
        .offset = offsetof(fixrate_args_t, cfg_frame_type)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        ...
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 255,
        .offset = offsetof(fixrate_args_t, rate_val)
    },
};

static const at_para_parse_syntax_t getrate_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
...
static const at_para_parse_syntax_t tpc_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t trc_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
...
static const at_para_parse_syntax_t rts_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const at_para_parse_syntax_t cca_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
...
static const at_para_parse_syntax_t intrf_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH | AT_SYNTAX_ATTR_FIX_CASE,
        .entry.string.max_length = 32,
...
static const at_para_parse_syntax_t tx_count_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 3,
        .offset = offsetof(tx_count_args_t, cfg_frame_type)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 7,
        .offset = offsetof(tx_count_args_t, tx_count0)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 7,
        .offset = offsetof(tx_count_args_t, tx_count1)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 7,
        .offset = offsetof(tx_count_args_t, tx_count2)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        ...
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 7,
        .offset = offsetof(tx_count_args_t, tx_count3)
    },
};

static const int32_t ps_ps_switch_values[] = {
    0, 1, 2, 3, 255
};
static const at_para_parse_syntax_t ps_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_LIST_VALUE,
    ...
    },
    {
        ...
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE | AT_SYNTAX_ATTR_OPTIONAL,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 4000,
        .offset = offsetof(ps_args_t, sleep_time)
    },
};

static const int32_t ps_debug_values[] = {
    0, 1, 2, 3, 4, 5, 6
};
static const at_para_parse_syntax_t ps_debug_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_LIST_VALUE,
        .entry.int_list = {7, ps_debug_values},
        .offset = offsetof(ps_debug_args_t, psm_debug_cmd)
    },
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        ...
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 1,
        .offset = offsetof(ps_debug_args_t, psm_debug_switch)
    },
};

static const at_para_parse_syntax_t wifi_net_type_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 2, // 2 : sta
        .entry.int_range.max_val = 3, // 3 : softap
        .offset = offsetof(wifi_tsf_args_t, net_type)
    },
};

static const int32_t psd_enable_values[] = {
    0, 1
};

static const at_para_parse_syntax_t psd_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_LIST_VALUE,
...
static const at_para_parse_syntax_t wifi_dscp_tid_map_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 2, // 2 : sta
        .entry.int_range.max_val = 3, // 3 : softap
        .offset = offsetof(dscp2tid_map_arg_t, net_type)
    },
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH,
        .entry.string.max_length = 66,
        .offset = offsetof(dscp2tid_map_arg_t, dscp2tid_map)
    },
};

static const at_cmd_entry_t at_wifi_cmd_parse_table[] = {
    {
        "CC",
        3,
        0,
    ...
    },
    {
        ...
        tx_count_syntax,
        NULL,
        (at_set_func_t)cmd_set_tx_count,
        NULL,
        NULL,
    },
    {
        ...
        fixrate_syntax,
        NULL,
        (at_set_func_t)cmd_autorate_fix_rate,
        NULL,
        NULL,
    },
    {
    ...
    },
    {
        ...
        ps_debug_syntax,
        NULL,
        (at_set_func_t)cmd_set_sta_psm_debug,
        NULL,
        NULL,
    },
    {
    ...
    },
    {
        ...
        1,
        0,
        wifi_net_type_syntax,
        NULL,
        (at_set_func_t)cmd_get_wifi_tsf,
        NULL,
        NULL,
    },
    {
        ...
        13,
        0,
        wifi_dscp_tid_map_syntax,
        NULL,
        (at_set_func_t)cmd_set_dscp_tid_map,
        NULL,
        NULL,
    },
};
