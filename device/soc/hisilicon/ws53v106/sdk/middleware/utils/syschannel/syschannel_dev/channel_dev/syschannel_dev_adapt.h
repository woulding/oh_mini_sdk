...
unsigned int syschannel_send_msg(syschannel_handler *handler, char* buf, int length,
    unsigned int syschannel_sub_type_msg);
...
osal_void syschannel_dev_sync_mac_ip_addr(const osal_u8 *addr, osal_u8 addr_len, const ip4_addr_t *ipaddr,
...
osal_void syschannel_dev_heartbeat_timer_reinit(bus_type type);
