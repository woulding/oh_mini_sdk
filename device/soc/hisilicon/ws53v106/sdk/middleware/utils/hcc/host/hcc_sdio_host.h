...
#define HCC_SDIO_HOST2DEV_SCATT_MAX       10
/* The max scatter buffers when device to host */
#define HCC_SDIO_DEV2HOST_SCATT_MAX       10
#define SDIO_MAX_XFER_LEN               (1024 * 16)
#else
/* The max scatter buffers when host to device */
...
#define CONFIG_SDIO_RESCAN
    ...
    extern int sdhci_nebula_sdio_rescan(int slot);
#else
