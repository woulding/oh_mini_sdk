...
class upg_base_info:
    def __init__(self, conf):
        ...
        self.app_bin = os.path.join(self.output, "ws53_liteos_app_sign.bin")
        self.test_bin = os.path.join(self.output, "ws53_liteos_testsuite_sign.bin")
        self.nv_bin = os.path.join(self.output, "ws53_all_nv.bin")

        self.flashboot_old_bin = os.path.join(self.output, "flashboot_sign.bin")
        self.app_old_bin = os.path.join(self.output, "ws53_liteos_app_sign.bin")
        self.test_old_bin = os.path.join(self.output, "ws53_liteos_testsuite_sign.bin")
        self.nv_old_bin = os.path.join(self.output, "ws53_all_nv.bin")
