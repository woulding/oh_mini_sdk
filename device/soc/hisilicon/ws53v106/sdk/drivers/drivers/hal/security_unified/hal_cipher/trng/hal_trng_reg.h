...
#define TRNG_SAMPLE_DIV_CLKEN               1
...
typedef union {
    /* Define the struct bits */
    struct {
        td_u16  cfg_m_trng_sample_div_num           : 4;   /* [0..3] */
        td_u16  cfg_m_trng_sample_load_div_en       : 1;   /* [4] */
        td_u16  cfg_m_clk_trng_sample_div_clken     : 1;   /* [5] */
        td_u16  reserved_0                          : 15;  /* [15..6] */
    } bits;
