 ...
 *
 * Description: Provides v151_100 spi register \n
 */
#ifndef HAL_SPI_V151_100_REGS_DEF_H
#define HAL_SPI_V151_100_REGS_DEF_H
...
/**
 * @defgroup drivers_hal_spi_v151_100_regs_def SPI v151_100 Regs Definition
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
union spi_v151_100_interrupt_data {
    uint32_t d32;                       /*!< Raw register data. */
    struct {
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
typedef union spi_v151_100_interrupt_data spi_inmar_data_t;
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
typedef union spi_v151_100_interrupt_data spi_insr_data_t;
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
typedef union spi_v151_100_interrupt_data spi_rainsr_data_t;
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
union spi_v151_100_dmadlr_data {
    uint32_t d32;                       /*!< Raw register data. */
    struct {
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
typedef union spi_v151_100_dmadlr_data spi_dtdl_data_t;
 ...
 *         set/clear the bits using the <i>b</i> elements.
 */
typedef union spi_v151_100_dmadlr_data spi_drdl_data_t;
 ...
 */
typedef struct spi_v151_100_regs {
