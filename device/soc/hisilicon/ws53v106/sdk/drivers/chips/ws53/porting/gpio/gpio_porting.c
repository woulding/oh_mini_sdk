...
static hal_gpio_group_info_t const g_gpio_channel_0_group_info[GPIO_CHANNEL_0_GROUP_NUM] = {
    // S_MGPIO0 ~ S_MGPIO22, pin 1/6/7/11/16, pin 14/15/21 are unusable.
    {
