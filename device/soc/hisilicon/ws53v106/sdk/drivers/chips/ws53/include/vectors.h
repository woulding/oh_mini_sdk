/*
 * Copyright (c) HiSilicon (Shanghai) Technologies Co., Ltd. 2018-2021. All rights reserved.
 * Description:  ws53 Vector Table Definitions
 *
 * Create:  2018-10-15
 */
#ifndef VECTORS_H
...
typedef struct {
    ...
    uint32_t stack_pc[SYSERR_PRINT_SIZE];
} stack_info_t;

typedef struct {
    stack_info_t st_info;
    exc_context_t context;
} except_info_t;
