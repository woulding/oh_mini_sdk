...
typedef union {
    struct {
        uint16_t glb_clken_mcu_core : 1;
        uint16_t glb_clken_mcu_perp_ls : 1;
        uint16_t glb_clken_mcu_perp_uart : 1;
        uint16_t glb_clken_mcu_perp_spi : 1;
        uint16_t reserved1 : 2;
        uint16_t glb_clken_xip_opi : 1;
        uint16_t glb_clken_xip_qspi : 1;
        uint16_t reserved2 : 3;
        uint16_t glb_fon_com_bus : 1;
        uint16_t glb_clken_lasdc : 1;
...
typedef union {
    struct {
        ...
        uint16_t qspi1_div_en : 1;
        uint16_t reserved2 : 1;
        uint16_t qspi1_div_clken : 1;
        uint16_t xip_bus_clken : 1;
        uint16_t qspi1_clken : 1;
        uint16_t reserved3 : 3;
        uint16_t qspi1_xip_clken : 1;
