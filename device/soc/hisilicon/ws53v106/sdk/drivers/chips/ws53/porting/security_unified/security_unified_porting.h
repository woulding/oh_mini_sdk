...
/* Register Base Addr. */
#define SEC_SUBSYS_BASE_ADDR    0x52010000
...
#define FAPC_REG_BASE_ADDR      (0x53000000)
...
#define CRYPTO_SYMC_HARD_CHANNEL_MAX    2
#define CRYPTO_SYMC_HARD_CHANNEL_MASK   (0xFFFE)

/* hash hard channel num. */
#define CRYPTO_HASH_HARD_CHN_CNT        2
...
#else
#define PKE_ROM_LIB_START_ADDR              (0x52072000)  /* the instr start address */
#endif
...
/* IRQ Numbers. */
#define PKE_REE_IRQ_NUM             (26 + 32)
#define SPACC_REE_IRQ_NUM           (26 + 33)
#define RKP_REE_IRQ_NUM             (26 + 34)
#define KLAD_REE_IRQ_NUM            (26 + 35)

#define TRNG_SEC_CFB                        (0x52001600)

/* for chips SOC integration releated config */
#define CONFIG_PKE_RAM_MASK_SUPPORT
#define CRYPTO_HASH_SOFT_ADDR_NOT_ALIGN_SUPPORT
