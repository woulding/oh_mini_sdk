...
#define PATCH_T __attribute__((section(".patch.text")))
#define PATCH_R __attribute__((section(".patch.rodata")))
#define PATCH_D __attribute__((section(".patch.data")))
#define PATCH_B __attribute__((section(".patch.bss")))
