...
void get_curve_type(mbedtls_ecp_group_id grp_id, mbedtls_alt_ecp_curve_type *curve_type, unsigned int *klen);
...
int ecp_priv_key_create(mbedtls_alt_ecp_curve_type ecc_type, unsigned int klen, const mbedtls_mpi *d,
    drv_pke_data *priv_key);

int ecp_pub_key_create(mbedtls_alt_ecp_curve_type ecc_type, unsigned int klen, const mbedtls_ecp_point *pub,
