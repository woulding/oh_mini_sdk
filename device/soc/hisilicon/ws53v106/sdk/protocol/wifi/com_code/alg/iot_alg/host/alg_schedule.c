...
OSAL_STATIC osal_u32 alg_schedule_rr_sch(alg_schedule_stru *schedule, osal_u8 vap_id, osal_u8 ac_num,
...
功能描述  : 简单的轮询调度算法
 ******************************************************************************/
OSAL_STATIC WIFI_TCM_TEXT osal_u32 alg_schedule_rr_sch(alg_schedule_stru *schedule, osal_u8 vap_id, osal_u8 ac_num,
    alg_sch_output_stru *sch_result)
{
    ...
    alg_sch_output_stru *sch_result)
{
    ...
    ret = alg_schedule_rr_sch(schedule, vap_id, ac_num, sch_result);
    if (osal_unlikely(ret != OAL_SUCC)) {
