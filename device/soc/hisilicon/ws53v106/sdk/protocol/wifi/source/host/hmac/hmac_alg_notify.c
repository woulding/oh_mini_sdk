...
/*****************************************************************************
 ...
 功能描述  : 获取TID下的私有数据结构体
*****************************************************************************/
WIFI_HMAC_TCM_TEXT_SMALLER WIFI_TCM_TEXT osal_u32 hmac_alg_get_device_priv_stru(const hal_to_dmac_device_stru *hal_dev,
...
/*****************************************************************************
 ...
 功能描述  : 获取USER私有数据结构体
*****************************************************************************/
WIFI_HMAC_TCM_TEXT_SMALLER WIFI_TCM_TEXT osal_u32 hmac_alg_get_user_priv_stru(const hmac_user_stru * const hmac_user,
...
/*****************************************************************************
 功能描述  : 查看算法是否注册
*****************************************************************************/
WIFI_TCM_TEXT WIFI_HMAC_TCM_TEXT_SMALLER oal_bool_enum_uint8 hmac_alg_is_registered(hmac_alg_id_enum_uint32 alg_id)
{
...
osal_void hmac_alg_cca_opt_radar_notify(osal_bool radar_switch)
{
    ...
    if (alg_stru->alg_cca_opt_radar_notify_func != OSAL_NULL) {
        alg_stru->alg_cca_opt_radar_notify_func(radar_switch);
    }
...
WIFI_TCM_TEXT WIFI_HMAC_TCM_TEXT_SMALLER osal_void *hmac_alg_get_algorithm_main(osal_void)
{
