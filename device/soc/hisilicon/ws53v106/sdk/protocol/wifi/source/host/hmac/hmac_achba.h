...
/*****************************************************************************
  7 STRUCT定义
*****************************************************************************/
typedef osal_s32 (*oal_achba_get_chba_cap)(oal_achba_net_stru *netdev, osal_u8 *buff, osal_u32 buff_len);
typedef osal_s32 (*oal_achba_wifi_link_add)(oal_achba_net_stru *netdev, const osal_u8 *user_mac, osal_u32 mac_len,
    const osal_s8 *achba_cap, osal_u32 cap_len);
typedef osal_s32 (*oal_achba_wifi_link_del)(oal_achba_net_stru *netdev, osal_s32 achba_link_id);
...
struct hmac_achba_drv_to_wifi_ops {
...
extern osal_s32 oal_achba_register_wifi_intfs(const struct hmac_achba_drv_to_wifi_ops *callee_intfs,
    struct oal_achba_caller_intfs *caller_intfs);
extern osal_s32 hmac_config_ind_achba_keepalive(hmac_vap_stru *hmac_vap, frw_msg *msg);
