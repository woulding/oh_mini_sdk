...
#endif
    mac_mib_set_AmsduPlusAmpduActive(hmac_vap, amsdu_ampdu_cfg->tx_switch);
    hmac_vap->rx_ampduplusamsdu_active = amsdu_ampdu_cfg->rx_switch;
    hmac_vap->force_amsdu_active = amsdu_ampdu_cfg->force_tx_on;
