...
OAL_STATIC WIFI_HMAC_TCM_TEXT_SMALLER WIFI_TCM_TEXT hmac_frag_user_info_stru *hmac_frag_get_user_info(osal_u16 user_idx)
{
...
OAL_STATIC WIFI_HMAC_TCM_TEXT_SMALLER WIFI_TCM_TEXT osal_u32 hmac_frag_start(hmac_vap_stru *hmac_vap,
...
OAL_STATIC WIFI_HMAC_TCM_TEXT_SMALLER WIFI_TCM_TEXT oal_netbuf_stru *hmac_defrag_start(hmac_user_stru *hmac_user,
