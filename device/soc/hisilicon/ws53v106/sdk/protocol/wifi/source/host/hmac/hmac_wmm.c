...
OSAL_STATIC osal_u32 hmac_config_set_wmm_qap_params(hmac_vap_stru *hmac_vap, hmac_config_wmm_para_stru *cfg_stru)
{
    ...
    switch (cfg_stru->cfg_id) {                                                    /* 根据sub-ioctl id填写WID */
        ...
        case WLAN_MSG_W2H_CFG_QEDCA_TABLE_MSDU_LIFETIME:
            ...
            mac_mib_set_QAPEDCATableMSDULifetime(hmac_vap, (osal_u8)cfg_stru->ac, (osal_u32)value);
...
OSAL_STATIC osal_s32 hmac_config_set_wmm_params(hmac_vap_stru *hmac_vap, hmac_config_wmm_para_stru *cfg_stru)
{
    ...
    switch (cfg_id) {                                                    /* 根据sub-ioctl id填写WID */
        case WLAN_MSG_W2H_CFG_EDCA_TABLE_CWMIN:
            ...
            mac_mib_set_edca_table_cwmin(hmac_vap, (osal_u8)ac, (osal_u32)value);
            break;
        ...
        case WLAN_MSG_W2H_CFG_EDCA_TABLE_CWMAX:
            ...
            mac_mib_set_edca_table_cwmax(hmac_vap, (osal_u8)ac, (osal_u32)value);
            break;
        ...
        case WLAN_MSG_W2H_CFG_EDCA_TABLE_AIFSN:
            ...
            mac_mib_set_edca_table_aifsn(hmac_vap, (osal_u8)ac, (osal_u32)value);
            break;
        ...
        case WLAN_MSG_W2H_CFG_EDCA_TABLE_TXOP_LIMIT:
            ...
            mac_mib_set_edca_table_txop_limit(hmac_vap, (osal_u8)ac, (osal_u32)value);
            break;
