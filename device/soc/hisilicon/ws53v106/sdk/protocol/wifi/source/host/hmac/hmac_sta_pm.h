...
typedef enum {
    ...
    HMAC_NOT_SLEEP_APP,
    HMAC_NOT_SLEEP_DEV_SLEEP,
    HMAC_NOT_SLEEP_HOST_TID,
    HMAC_NOT_SLEEP_HOST_WAKEUP,
    HMAC_NOT_SLEEP_HOST_WAKEUP_FAIL,
    HMAC_NOT_SLEEP_READ_REG,
    HMAC_NOT_SLEEP_DEV_ALLOW_SLEEP,
    HMAC_NOT_SLEEP_DEV_DISALLOW_SLEEP,
    HMAC_NOT_SLEEP_CSA_SWTICH_RUNNING,
...
typedef struct {
    ...
    osal_u8 csa_is_waiting_flag;
    osal_u8 ps_enable_ctrl : 1;
    osal_u8 rsv : 7;
...
WIFI_HMAC_TCM_TEXT_SMALLER osal_u32 hmac_wifi_pm_get_host_allow_sleep(osal_void);
...
typedef osal_void (*hmac_sta_pm_csa_flag_set_cb)(osal_u8);
