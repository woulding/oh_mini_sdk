...
/* oal_net.h */
static inline td_s32 oal_netbuf_expand_head(oal_netbuf_stru *netbuf, td_u32 nhead, td_s32 ntail, td_s32 gfp_mask)
{
    return pskb_expand_head(netbuf, nhead, (td_u32)ntail, gfp_mask);
}
...
static inline td_u32 oal_netbuf_reserve_header(oal_netbuf_stru *netbuf)
{
    ...
    if (header_len < (td_u32)OAL_HDR_TOTAL_LEN) {
        return (td_u32)oal_netbuf_expand_head(netbuf, (td_s32)((td_u32)OAL_HDR_TOTAL_LEN - header_len), 0, 0);
    }
    return OAL_NETBUF_SUCC;
}
#endif
