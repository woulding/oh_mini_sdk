...
typedef struct {
    ...
    osal_u8 single_probe_times : 3;                 /* 单个probe req发送次数,相当于host侧重发次数, 最多7次 */
...
typedef struct {
    ...
    osal_u32 tx_rts_num;
} mac_frame_trx_info_stru;

typedef struct {
    osal_u64 bcn_succ;
    osal_u64 bcn_fail;
} mac_beacon_statistics_stru;
...
typedef struct {
    ...
    osal_s8 snr;
    osal_u8 resv[3];
} mac_user_rate_statistics_stru;

typedef struct {
    mac_frame_trx_info_stru trx_info;
    mac_beacon_statistics_stru bcn_stat;
    mac_user_rate_statistics_stru user_rate_stat;
