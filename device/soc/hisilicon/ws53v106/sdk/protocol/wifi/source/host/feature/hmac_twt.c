...
*****************************************************************************/
OSAL_STATIC osal_u32 hmac_mgmt_encap_twt_setup_req(hmac_vap_stru *hmac_vap, const hmac_user_stru *hmac_user,
...
*****************************************************************************/
OSAL_STATIC osal_u32 hmac_mgmt_encap_twt_teardown_req(hmac_vap_stru *hmac_vap, const hmac_user_stru *hmac_user,
    ...
    osal_u8 *payload)
{
    ...
    /* twt_interval与twt_min_duration校验 0xffffffff: 寄存器最大位数 */
    if ((twt_interval == 0) || (twt_interval > 0xffffffff) || (twt_interval < (osal_u64)twt_wake_duration)) {
...
OSAL_STATIC osal_u32 hmac_sta_up_rx_action_s1g(oal_netbuf_stru **netbuf, hmac_vap_stru *hmac_vap)
{
    ...
    /* contine&fail返回值转发流程均有处理，succ需要业务自己free */
