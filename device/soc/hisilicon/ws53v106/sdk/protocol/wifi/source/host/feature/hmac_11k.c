    ...
    hmac_vap_stru *hmac_vap, mac_action_rm_req_stru *rm_req, osal_u16 *frame_len)
{
    ...
    hmac_encap_da_sa_bssid_fragment(mac_hdr, WLAN_PROTOCOL_VERSION | WLAN_FC0_TYPE_MGT | WLAN_FC0_SUBTYPE_ACTION,
        hmac_user->user_mac_addr, mac_mib_get_station_id(hmac_vap), hmac_vap->bssid);
