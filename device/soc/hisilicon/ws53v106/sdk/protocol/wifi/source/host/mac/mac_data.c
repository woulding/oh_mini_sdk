...
*****************************************************************************/
WIFI_HMAC_TCM_TEXT_SMALLER oal_bool_enum_uint8 hmac_is_dhcp_port_etc(mac_ip_header_stru *ip_hdr)
{
...
WIFI_HMAC_TCM_TEXT_SMALLER OAL_STATIC osal_u8 mac_get_data_type_by_ethertype(const osal_u8 *frame_body,
