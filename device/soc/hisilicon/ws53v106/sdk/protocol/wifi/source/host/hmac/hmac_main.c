...
/*****************************************************************************
  3 函数实现
*****************************************************************************/
osal_s32 hmac_config_wifi_init_params(osal_void)
{
    frw_msg msg_info = {0};
    mac_config_wifi_init_params wifi_init_params = {0};

    wifi_init_params.sta_keepalive_time = WLAN_CFG_STA_KEEPALIVE_TIME;
    frw_msg_init((osal_u8 *)&wifi_init_params, sizeof(mac_config_wifi_init_params), OSAL_NULL, 0, &msg_info);
    return frw_send_msg_to_device(0, WLAN_MSG_H2D_C_CFG_WIFI_INIT_PARAMS, &msg_info, OSAL_TRUE);
}
...
OSAL_STATIC osal_void frw_wifi_module_exit(osal_void)
{
    ...
    frw_wifi_module_func_exit module_exit_func[] = {
        ...
        hmac_btcoex_deinit,        hmac_al_tx_rx_deinit,        hmac_achba_deinit,
    ...
    frw_wifi_module_func_exit module_exit_func[] = {
        ...
        hmac_ap_obss_deinit_weakref,       hmac_al_tx_rx_deinit_weakref,        hmac_achba_deinit_weakref,
        hmac_net_diagnosis_deinit_weakref,
    };
#endif
...
OSAL_STATIC osal_void frw_wifi_module_init(osal_void)
{
    ...
    frw_wifi_module_func_init module_init_func[] = {
        ...
        hmac_btcoex_init,        hmac_al_tx_rx_init,        hmac_achba_init,
    };
#else
    frw_wifi_module_func_init module_init_func[] = {
        ...
        hmac_ap_obss_init_weakref,        hmac_al_tx_rx_init_weakref,       hmac_achba_init_weakref,
        hmac_net_diagnosis_init_weakref,
    };
#endif
