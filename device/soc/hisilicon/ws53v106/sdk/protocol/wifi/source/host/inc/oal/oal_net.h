...
#define MAC_IP6_NEXTH_ICMP6 58
#define MAC_ICMP6_TYPE_EREQ 128 /* IPV6 Echo request */
#define MAC_ICMP6_TYPE_EREP 129 /* IPV6 Echo reply */
...
extern oal_bool_enum_uint8 oal_netbuf_is_icmp6_etc(oal_ipv6hdr_stru  *ip6_hdr);
...
oal_bool_enum_uint8 oal_netbuf_is_icmp6_etc(oal_ipv6hdr_stru  *ip6_hdr);
...
#if defined(_PRE_OS_VERSION_LITEOS) && defined(_PRE_OS_VERSION) && (_PRE_OS_VERSION_LITEOS == _PRE_OS_VERSION)
typedef oal_lwip_netif oal_achba_net_stru;
#define oal_get_achba_net(hmac_vap) ((hmac_vap)->net_device->lwip_netif)
...
#elif defined(_PRE_OS_VERSION_LINUX) && defined(_PRE_OS_VERSION) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
typedef oal_net_device_stru oal_achba_net_stru;
#define oal_get_achba_net(hmac_vap) ((hmac_vap)->net_device)
#endif
