...
#if defined(_PRE_OS_VERSION_LITEOS) && defined(_PRE_OS_VERSION) && (_PRE_OS_VERSION_LITEOS == _PRE_OS_VERSION)
extern void uapi_at_print(const char* str, ...);
#define wifi_at_print(fmt, arg...) uapi_at_print(fmt, ##arg)
#else
#define wifi_at_print(fmt, arg...) wifi_printf_always(fmt, ##arg)
#endif
...
#define WIFI_HMAC_TCM_TEXT_SMALLER
#define WIFI_HMAC_TCM_RODATA
#elif defined(_PRE_WLAN_FEATURE_WS53) && !defined(_PRE_FEATURE_WS53_DEVICE_MODE) && !defined(CONFIG_MCU_MODE_3)
#define WIFI_TCM_TEXT
#define WIFI_TCM_RODATA __attribute__((section(".wifi.tcm.rodata")))
#ifdef _PRE_WLAN_TCM_SMALLER
#define WIFI_HMAC_TCM_TEXT_SMALLER
#else
#define WIFI_HMAC_TCM_TEXT_SMALLER __attribute__((section(".wifi.tcm.text")))
