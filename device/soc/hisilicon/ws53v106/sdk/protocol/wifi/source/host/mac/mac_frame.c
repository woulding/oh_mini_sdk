...
/*****************************************************************************
    全局变量定义
*****************************************************************************/
static const mac_frame_cb g_mac_frame_rom_cb = { OSAL_NULL,
    ...
    osal_u32 chan_report)
{
    ...
    hmac_encap_da_sa_bssid_fragment(mac_header, WLAN_PROTOCOL_VERSION | WLAN_FC0_TYPE_MGT | WLAN_FC0_SUBTYPE_ACTION,
        hmac_vap->bssid, mac_mib_get_station_id(hmac_vap), hmac_vap->bssid);
