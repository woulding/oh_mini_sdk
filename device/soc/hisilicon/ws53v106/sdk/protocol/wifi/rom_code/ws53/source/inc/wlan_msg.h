...
typedef enum {
    ...
    WLAN_MSG_H2D_C_CFG_WIFI_INIT_PARAMS,
    ...
    WLAN_MSG_H2D_C_CFG_GET_VAP_STAT,
    WLAN_MSG_H2D_C_CFG_TX_VAP_AGGRE_INFO,
    WLAN_MSG_H2D_C_CFG_ENABLE_VAP_STAT,
    ...
    WLAN_MSG_H2D_C_CFG_ONLINE_IQ_NOTIFY,     /* 通知device开始or结束online iq校准 */
    WLAN_MSG_H2D_C_CFG_SYNC_EXTCOEX_STATUS,
    WLAN_MSG_H2D_C_CFG_SET_CLEAN_CHANNEL_ENABLE,
    WLAN_MSG_H2D_C_CFG_GET_RETRY_RATIO,
    WLAN_MSG_H2D_C_CFG_GET_PM_DEBUG_INFO,
    WLAN_MSG_H2D_C_END
} wlan_msg_h2d_c_enum;
...
typedef enum {
    ...
    WLAN_MSG_W2D_C_CFG_SET_RF_PM,
    WLAN_MSG_W2D_C_CFG_ALWAYS_TX_RATIO,
    WLAN_MSG_W2D_C_CFG_SET_ER_SU_FAIL_CNT_TH,
    WLAN_MSG_W2D_C_CFG_ALG_SET_TX_COUNT,
    /* D2D patch */
...
typedef enum {
    ...
    WLAN_MSG_W2H_CFG_SET_EXT_TBTT_OFFSET,
    WLAN_MSG_W2H_CALI_ONLINE_CMD,
    WLAN_MSG_W2H_CFG_PSM_DEBUG,
    WLAN_MSG_W2H_CFG_GET_CHANNEL_SCORING,
    WLAN_MSG_W2H_CFG_ENABLE_STATISTICS,
    WLAN_MSG_W2H_CFG_GET_STATISTICS,
    WLAN_MSG_W2H_CFG_SET_PROBE_REQ_MAX,
    WLAN_MSG_W2H_CFG_GET_TID_DEBUG_INFO,
    WLAN_MSG_W2H_CFG_SET_DSCP_TID_MAP,
    WLAN_MSG_W2H_CFG_SET_CHANNEL_SCORING,
    WLAN_MSG_W2H_END
} wlan_msg_w2h_enum;
...
typedef enum {
    ...
    WLAN_MSG_D2H_ONLINE_IQ_CALI_COMPLETE,
