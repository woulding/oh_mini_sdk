...
#define RF_LDO1_POWER_ON_DELAY 250
...
#ifdef _PRE_WLAN_FEATURE_LP_11B_BCN_PARSE
/* 11b低功耗模式，需要配置4Mhz带宽             */
osal_void fe_hal_rf_set_11b_bw(osal_void);
osal_void fe_hal_rf_11b_bw_reg_save(hal_rf_dev *rf_dev);
#endif
...
// logen校准rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_logen_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);

// 获取txpwr的rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_txpwr_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);

// 获取rx_dc的rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_rx_dc_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);

// 获取tx_dc的rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_tx_dc_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
// dac校准rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_dac_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
// RC-bandwidth校准rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_rc_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
// RX RC-bandwidth校准rf path配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_rx_rc_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
// IQ 校准通路配置
const cali_path_cfg_reg_stru* fe_hal_rf_get_tx_iq_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
const cali_path_cfg_reg_stru* fe_hal_rf_get_rx_iq_path_cfg(osal_u32* list_count, wlan_channel_band_enum_uint8 band,
    cali_bandwidth_enum_uint8 bw, osal_u8 chain);
// 相角相关接口
...
osal_void fe_hal_rf_set_reg_rf_regctl(const hal_device_stru *device);
osal_void fe_hal_rf_set_reg_cbb_linectl(const hal_device_stru *device);
...
osal_void fe_hal_rf_config_tx_iq_cali_rx_gain(const hal_device_stru *device, osal_u8 cali_band, osal_u16 tpc_code);
...
osal_void fe_hal_rf_config_cali_power_tx_gain(const hal_device_stru *device, osal_u8 cali_band,
    osal_u8 chn_idx, osal_u16 tpc_code);
osal_void fe_hal_rf_config_cali_path_rx_gain(const hal_device_stru *device, osal_u8 cali_band,
    osal_u16 tpc_code);
...
osal_void fe_hal_rf_config_tx_dc_cali_rx_gain(const hal_device_stru *device, osal_u8 cali_band, osal_u8 tpc_code);
osal_u8 fe_hal_rf_get_upc_ppa_bits(osal_void);
cali_complex_stru fe_hal_rf_get_tx_dc_dc3(osal_u8 txdc_lvl_idx);
...
osal_void fe_hal_soc_reset_adc_man(osal_void);
// RC
...
osal_u16 fe_hal_rf_get_tx_pwr_cali_lvl_tpc_idx(const hal_rf_dev *rf_dev, wlan_channel_band_enum_uint8 band,
    osal_u8 lvl_num);
// R C iPA current 校准
...
osal_u8 fe_rf_hal_cal_ipa_current_bias(const hal_rf_dev *rf_dev,
    wlan_channel_band_enum_uint8 band, osal_u16 efuse_code);
osal_void fe_hal_rf_set_tx_pa_vd_m2(const hal_rf_dev *rf_dev, wlan_channel_band_enum_uint8 band,
...
osal_void fe_rf_power_on(osal_void);
osal_void fe_rf_ldo_set_delay_flag(osal_u8 need_delay);
osal_void fe_rf_poweron_wifi_rf_ldo1(osal_u8 need_all, osal_u8 value);
osal_void fe_rf_poweron_wifi_rf_ldo1_no_delay(osal_u8 is_no_delay);
// 11b 高功率的接口
osal_void fe_rf_set_11b_boost_power(osal_u8 flag);
osal_u8 fe_rf_get_11b_boost_power(osal_void);
osal_void fe_rf_reg_11b_power_default_restore(osal_void);
osal_void fe_rf_reg_11b_power_boost_restore(osal_void);
osal_u8 fe_hal_rf_get_rf_tsensor_code(const hal_rf_dev *rf_dev, wlan_channel_band_enum_uint8 band);
#ifdef __cplusplus
#if __cplusplus
}
#endif
