...
#define CALI_2G_TX_UPC_UNIT_VAL_MAX    (0xFF)   /* asic FF */
#define CALI_2G_TX_UPC_UNIT_VAL_MIN    (0x1)
#define CALI_POW_BASE_2G_UPC_IDX       (0x0)   /* UPC低档位的起始索引 */
#define CALI_POW_PPA_LUT_NUM           (10)    /* ppa LUT表的行数 */
#ifdef BOARD_ASIC_WIFI
#define CALI_TXPWR_GAIN_LVL_NUM        (1)     /* 因低功率档没有动态功率，上电功率删除低功率，只校准高功率 */
#else
