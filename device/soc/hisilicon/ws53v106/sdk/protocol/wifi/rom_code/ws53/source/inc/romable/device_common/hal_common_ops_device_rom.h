...
#define HAL_MAC_ERROR_Q_EMPTY_ERROR1 0x24006000
#define HAL_MAC_ERROR_Q_EMPTY_ERROR2 0x00000020
...
#ifdef _PRE_BUILD_ALG_NEW_ARCH
typedef hal_tx_ctrl_desc_rate_stru hal_rank_alg_param_stru;
#endif
...
typedef struct {
    ...
    osal_u8       report_ratio;    /* 探索完成后bcn接收率打印频率 */
    osal_u8       rsv[3];
...
#define TBTT_OFFSET_PROBE_REPORT_RATIO  2      /* beacon接收率打印频率 */
