...
#define ONLINE_CALI_UPC_ADJUST_MAX_GAIN       (25)    /* 每次UPC调整的最大增益 */
...
#define ONLINE_CALI_AL_TX_DYN_DELAY_PERIOD    (150)   /* 产线校准时,常发延迟进入动态校准时间 */
#else
#define ONLINE_CALI_AL_TX_DYN_DELAY_PERIOD    (200)
#endif
...
typedef struct alg_dyn_cali_val {
    ...
    frw_timeout_stru online_tx_iq_timer;
    frw_timeout_stru online_rx_iq_timer;
    ...
    oal_bool_enum_uint8 pdet_debug_switch;               /* 打印芯片上报pdet值的调试开关 */
