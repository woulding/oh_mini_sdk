...
#define CALI_POW_DIST_2G_OFDM_TABLE_LEN       (74)
#define CALI_POW_CAL_2G_OFDM_TABLE_LEN        CALI_POW_DIST_2G_OFDM_TABLE_LEN
#define CALI_POW_DIST_2G_DSSS_TABLE_LEN       (74)
#define CALI_POW_CAL_2G_DSSS_TABLE_LEN        CALI_POW_DIST_2G_DSSS_TABLE_LEN
...
const cali_pow_cal_gain_stru *cali_get_pow_cal_gain_2g_table(osal_u8 pow_table_idx);
