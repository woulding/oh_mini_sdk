...
/* 关联用户的最大个数 */
#define WLAN_ASSOC_USER_MAX_NUM                   4
#define WLAN_VAP_USER_HASH_MAX_VALUE         (WLAN_ASSOC_USER_MAX_NUM * 2)       /* 2为扩展因子 */
#define WLAN_DTCM_RAM_ASSOC_USER_MAX_NUM          4 /* DTCM_RAM中定义的关联用户最大个数，为总用户规格16的一半 */
...
/* 整个device所有TID的最大MPDU数量限制
    需要重新定义，以支持调度逻辑
*/
#define WLAN_TID_MPDU_NUM_BIT               5
...
#define WLAN_ACTIVE_USER_MAX_NUM                  4    /* 活跃用户的最大个数 */
