...
#define SLAVE_WAKEUP_WAIT_MS       800    /* Wake up wait ms. */
...
static const tiot_pm_event_entry g_slave_pm_event_map[TIOT_PM_EVENT_MAX] = {
    ...
    /* Device request sleep. */
    { TIOT_PM_TAG_CAN_ALLOW_SLEEP, TIOT_PM_STATE_SLEEPING, tiot_pm_slave_request_sleep_handle },
    /* Device recv allow sleep msg. */
    { TIOT_PM_TAG_CAN_SLEEP, TIOT_PM_STATE_SLEEP, tiot_pm_slave_sleep_ack_handle },
    /* Device NOT USE. */
    { TIOT_PM_TAG_INVALID, TIOT_PM_STATE_INVALID, NULL },
    /* Recv msg from host. */
    ...
    /* request sleep is ignored by host or dev no agree sleep. */
    { TIOT_PM_TAG_CAN_SLEEP, TIOT_PM_STATE_WORK, NULL }
};
...
static const tiot_device_info g_tiot_slave_device_info = {
