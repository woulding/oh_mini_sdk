...
void pm_state_work_to_standby(void)
{
...
void pm_state_standby_to_sleep(void)
{
...
void pm_sys_entry(void)
{
    ...
    osal_task *task_handle = osal_kthread_create((osal_kthread_handler)pm_sys_task, NULL,
                                                 "pm_sys", CONFIG_PM_SYS_STACK_SIZE);
    if (task_handle == NULL) {
